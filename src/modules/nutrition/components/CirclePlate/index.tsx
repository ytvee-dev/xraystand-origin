...
const CirclePlate: React.FC<CirclePlateProps> = ({
    content,
}: CirclePlateProps): ReactElement => {
    const screenWidth = useScreenWidth();
    const backgroundImage = paths.images.plate;
    const [currentBlock, setCurrentBlock] =
        React.useState<TDescriptionBlock>("unHovered");
    ...
    const DescriptionBlock = (): ReactElement => {
        const containerClasses =
            screenWidth > 768
                ? `quarters block-${currentBlock}`
                : `mobile-quarters mobile-block-${currentBlock}`;
        const descriptionClasses =
            screenWidth > 768
                ? `description-block ${currentBlock}`
                : `mobile-description-block ${currentBlock}`;
                ...
                <div className="circle-plate">
                    ...
                    <div className="circle">
                        <div className="quarters">
                            <div
                                className="quarter top-left"
                                onMouseEnter={() => handleChoose("top-left")}
                            />
                            <div
                                className="quarter top-right"
                                onMouseEnter={() => handleChoose("top-right")}
                            />
                            <div
                                className="quarter bottom-left"
                                onMouseEnter={() => handleChoose("bottom-left")}
                            />
                            <div
                                className="quarter bottom-right"
                                onMouseEnter={() =>
                                    handleChoose("bottom-right")
                                }
                            />
                        </div>
                    </div>
            ...
            <div className="circle-plate">
                ...
                <div className="circle">
                    <div className="quarters">
                        <div
                            className="quarter top-left"
                            onMouseEnter={() => handleChoose("mobile-top-left")}
                        />
                        <div
                            className="quarter top-right"
                            onMouseEnter={() =>
                                handleChoose("mobile-top-right")
                            }
                        />
                        <div
                            className="quarter bottom-left"
                            onMouseEnter={() =>
                                handleChoose("mobile-bottom-left")
                            }
                        />
                        <div
                            className="quarter bottom-right"
                            onMouseEnter={() =>
                                handleChoose("mobile-bottom-right")
                            }
                        />
                    </div>
                </div>
