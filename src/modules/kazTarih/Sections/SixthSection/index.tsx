...
const SixthSection = ({content, summaryCardFontSize}: IKazTarihProps): ReactElement => {
    ...
    return (
        <section className="kt-sixth-section">
            ...
            <div className="kt-sixth-section-content-wrapper">
                <h2 className="kt-title gr-font-family kt-sixth-section-title">{content.title}</h2>
                <p className="kt-description kt-sixth-section-description">{content.description}</p>

                <Carousel className="kt-formatter-card-wrapper">
                    {cards.map((card, index) =>
                        <TextFormatterCard items={card} theme="dark" key={index} className="kt-formatter-card"/>
                    )}
                </Carousel>
