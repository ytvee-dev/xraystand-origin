        ...
        <TwoColumnSection
            leftColumn={
                <LargeCard
                    ...
                    notificationLabel={
                        translation.fourthSection.notificationLabel
                    }
                >
                    <DefaultCardsListOL
                        content={
                            translation.fourthSection[
                                "content"
                            ] as TContentItem[]
                        }
            ...
            rightColumn={
                <SquareImageViewer
                    path={
                        "https://res.cloudinary.com/dy6zg8dhs/image/upload/v1768051920/cyclistsScooters_w9fulf.webp"
                    }
                    width={564}
                />
            }
