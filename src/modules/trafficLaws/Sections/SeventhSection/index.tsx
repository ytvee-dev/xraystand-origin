    ...
    return (
        <TwoColumnSection
            leftColumn={
                <SquareImageViewer
                    path={
                        "https://res.cloudinary.com/dy6zg8dhs/image/upload/v1768051930/pointsman_zlikq2.webp"
                    }
                    width={564}
                />
            }
            rightColumn={
                <LargeCard
                    ...
                    notificationLabel={
                        translation.seventhSection.notificationLabel
                    }
                >
                    <DefaultCardsListOL
                        content={
                            translation.seventhSection[
                                "content"
                            ] as TContentItem[]
                        }
                        imageIdData={
                            paths.trafficLawsPage.seventhSection.contentListData
                        }
