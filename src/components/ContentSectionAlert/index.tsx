...
const ContentSectionAlert = ({label}: IContentSectionAlertProps): ReactElement => {
    return (
        <Alert className="content-section-alert common-text" sx={{backgroundColor: "#FEFCF3"}} icon={<SpriteIcon iconId={SvgSpriteIds.CONTENT_SECTION_NOTIFICATION_ICON} size={ICON_SIZE} />}>
            {label}
        </Alert>
    );
};
