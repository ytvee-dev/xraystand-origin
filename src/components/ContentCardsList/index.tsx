        ...
        <div className="content-cards-list">
            {cardsTextData.map(
                (cardData: IImageCardResources, index: number) => (
                    <div className="content-cards-list-card-wrapper" key={index}>
                        <ContentImageCard
                            imageId={imageIdData[index]}
                            title={cardData.title && cardData.title}
                            label={cardData.label && cardData.label}
                            linkText={cardData.linkText && cardData.linkText}
                            action={cardData.action && cardData.action}
                        />
                    </div>
                )
            )}
